...
is.loop <- function(graph , eids = E(graph)) {
   lifecycle::deprecate_soft("1.5.0", "is.loop()", "which_loop()")
...
is.simple <- function(graph) {
   lifecycle::deprecate_soft("1.5.0", "is.simple()", "is_simple()")
...
has.multiple <- function(graph) {
   lifecycle::deprecate_soft("1.5.0", "has.multiple()", "any_multiple()")
...
is.connected <- function(graph , mode = c("weak","strong")) {
   lifecycle::deprecate_soft("1.5.0", "is.connected()", "is_connected()")
...
largest.cliques <- function(graph) {
   lifecycle::deprecate_soft("1.5.0", "largest.cliques()", "largest_cliques()")
