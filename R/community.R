...
mod.matrix <- function(graph , membership , weights = NULL , resolution = 1 , directed = TRUE) {
   lifecycle::deprecate_soft("1.5.0", "mod.matrix()", "modularity_matrix()")
...
is.hierarchical <- function(communities) {
   lifecycle::deprecate_soft("1.5.0", "is.hierarchical()", "is_hierarchical()")
...
showtrace <- function(communities) {
   lifecycle::deprecate_soft("1.5.0", "showtrace()", "show_trace()")
