...
#' `r lifecycle::badge("deprecated")`
#'
#' `asPhylo()` was renamed to `membership()` to create a more
#' consistent API.
#' @inheritParams membership
#' @keywords internal
#' @export
asPhylo <- function(x , ...) {
   lifecycle::deprecate_soft("1.5.0", "asPhylo()", "membership()")
   membership(x = x, ...)
}
...
#' `r lifecycle::badge("deprecated")`
#'
#' `asPhylo.communities()` was renamed to `membership()` to create a more
#' consistent API.
#' @inheritParams membership
#' @keywords internal
#' @export
asPhylo.communities <- function(x , use.modularity = FALSE , ...) {
   lifecycle::deprecate_soft("1.5.0", "asPhylo.communities()", "membership()")
   membership(x = x, use.modularity = use.modularity, ...)
}
